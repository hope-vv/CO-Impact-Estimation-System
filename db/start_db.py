...
-- Raw product data
CREATE TABLE IF NOT EXISTS open_beauty.raw_products (
...
-- Parsed products
CREATE TABLE IF NOT EXISTS open_beauty.products (
    id SERIAL PRIMARY KEY,
...
-- Ingredients
CREATE TABLE IF NOT EXISTS open_beauty.ingredients (
    id SERIAL PRIMARY KEY,
...
-- Product-Ingredient
CREATE TABLE IF NOT EXISTS open_beauty.product_ingredients (
    id SERIAL PRIMARY KEY,
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_products_brand ON open_beauty.products(brands);
CREATE INDEX IF NOT EXISTS idx_products_category ON open_beauty.products(categories);
CREATE INDEX IF NOT EXISTS idx_products_raw_product ON open_beauty.products(raw_product_id);

CREATE INDEX IF NOT EXISTS idx_ingredients_inci_name ON open_beauty.ingredients(inci_name);

CREATE INDEX IF NOT EXISTS idx_product_ingredients_product ON open_beauty.product_ingredients(product_id);
CREATE INDEX IF NOT EXISTS idx_product_ingredients_ingredient ON open_beauty.product_ingredients(ingredient_id);

CREATE INDEX IF NOT EXISTS idx_ingredient_emissions_ingredient ON open_beauty.ingredient_emissions(ingredient_id);
CREATE INDEX IF NOT EXISTS idx_co2_metrics_product ON open_beauty.co2_metrics(product_id);
